...
<div class="row">
	...
	@foreach($brands as $brand)
							...
							<div class="form-group" id="brand">
								...
								<div class="col-lg-7">
									<input type="text" class="form-control" id="prescribed" name="prescribed" placeholder="Type to SKU" required>
								</div>
							</div>
				        </div>
						...
						<div id="demo-stk-lft-tab-7" class="tab-pane fade">
						     <div class="form-group">
								...
								<div class="col-lg-9">
									<textarea name="short_description" rows="8" class="editor form-control"  placeholder="{{__('Short Description')}}"></textarea>
								</div>
							</div>
							<div class="form-group">
								<label class="col-lg-2 control-label">{{__('Description')}}</label>
