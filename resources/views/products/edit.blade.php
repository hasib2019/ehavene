...
<div class="row">
				    ...
				    <div class="tab-content">
				        <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
							...
							<div class="form-group">
	                            ...
	                            <div class="col-lg-7">
	                                <input type="text" class="form-control" name="slug" placeholder="{{__('Product Slug')}}" value="{{$product->slug}}" required>
	                            </div>
	                        </div>
	...
	<option>Select an option</option>
							...
							<div class="form-group" id="prescribed">
	                            ...
	                            <div class="col-lg-7">
									<input type="text" class="form-control" id="prescribed" name="prescribed" value="{{$product->prescribed}}" placeholder="Type to SKU" required>
						...
						<div id="demo-stk-lft-tab-7" class="tab-pane fade">
						      <div class="form-group">
								...
								<div class="col-lg-9">
									<textarea name="short_description" rows="4" class="editor form-control"  placeholder="{{__('Short Description')}}">{{$product->short_description}}</textarea>
								</div>
								    	<div class="form-group">
	                            <label class="col-lg-2 control-label">{{__('Description')}}</label>
	                            <div class="col-lg-9">
