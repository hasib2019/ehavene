    ...
    <div id="" style="margin-bottom: 20px;">
        <div style="width:50%; float:left;">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <select class="form-control mb-3" data-placeholder="Select your City" id="district" name="city">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <select class="form-control mb-3" data-placeholder="Select your Area" id="upazila" name="area">
            ...
            {{-- <div class="form-group">
                <label class="col-lg-4 control-label">{{__('Area')}}</label>
                <div class="col-lg-8">
                    <select class="form-control mb-3" data-placeholder="Select shipping Cost " id="shipping" name="shipping_cost">
        ...
        <div style="width: 25%; float:right; margin-top: 9%">
            <table id="meta">
                <select name="payment_option" id="" hidden>
    ...
    <table id="items" style="margin-top: 20px">
        ...
        <tr class="item-row">
            <td  colspan="3" class="item-name vehicle-type"><div class="delete-wpr">
              <select class="form-control medication select" name="product_id[]" id="select_car" required>
              ...
              <td><input type="text" name="price[]" id="" class="cost price-input form-control" readonly></td>
              <td><input type="number" required name="qty[]" min="1" value="1" class="form-control qty" id=""></td>
        ...
        <tr>
            <td colspan="4" class="blank"> </td>
            <td colspan="1" class="total-line">Shipping Cost</td>

            {{-- <td class="total-value"><textarea id="paid">00</textarea></td> --}}
            <td class="total-value"><select class="form-control mb-3" data-placeholder="Select shipping Cost " id="shipping" name="shipping_cost">
              <option>0</option>
          </select></td>
        </tr>
        <tr>
...
<div class="form-check">
    <input class="form-check-input" type="checkbox" value="1" name="checkusser" id="flexCheckDefault">
    <label class="form-check-label" for="flexCheckDefault">
      Medication
    </label>
  </div>

    <input type="submit" value="confirm" class="btn btn-success" style="margin-top: 10px">
</form>
</div>
    ...
    //   from
      ...
      $(document).ready(function() {
        ...
        $("#addrow").click(function(){
            $(".item-row:last").after(`<tr class="item-row"><td class="item-name vehicle-type"><div class="delete-wpr"><select class="form-control medication select" name="product_id[]" id="">
                @foreach ($peoducts as $peoduct)
                <option data-price="{{$peoduct->unit_price}}" value="{{$peoduct->id}}">{{$peoduct->name}}</option>
                @endforeach
            </select><a class="delete" href="javascript:;" title="Remove row">X</a></div></td><td class="description"><textarea></textarea></td><td><input type="text" name="price[]" id="" class="cost price-input form-control" readonly></td><td><input type="number" required name="qty[]" value="1" class="form-control qty" min="1" id=""></td><td><span class="price">00</span></td></tr>`);
            $(".medication").select2();
...
<script>
//    select division district section
