            ...
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Add New Post') }} <a class="add-btn"
                            href="{{ route('admin-blog-index') }}"><i class="fa fa-arrow-left"></i> {{ __('Back') }}</a>
                    </h4>
                    <ul class="links">
                        <li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area">
                            <div class="gocover"
                                style="background: url({{asset('images/loader.gif')}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);">
                            </div>
                            @include('admin.form-both')
                            <form id="geniusform" action="{{ route('admin-blog-create') }}" method="POST"
                                    ...
                                    <div class="col-lg-7">
                                        <div class="img-upload">
                                            <div id="image-preview" class="img-preview"
                                                ...
                                                <input type="file" name="photo" class="img-upload form-control" id="image-upload">
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field form-control" name="source"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="text-editor">
                                                <textarea class="input-field form-control" name="meta_description"
