        ...
        <div class="navbar-content">
            ...
            <ul class="nav navbar-top-links">
                ...
                <li class="dropdown" id="lang-change">
                    ...
                    @endphp
                    <a href="" class="dropdown-toggle top-bar-item" data-toggle="dropdown">
                        <img src="{{ asset('frontend/images/icons/flags/'.$locale.'.png') }}" class="flag" style="margin-right:6px;"><span class="language">{{ \App\Models\Language::where('code', $locale)->first()->name }}</span>
                    </a>
                        ...
                        <div class="nano scrollable has-scrollbar" style="height: 265px;">
                            <div class="nano-content" tabindex="0" style="right: -17px;">
                                <ul class="head-list">
                                    ...
                                    @if($orders > 0)
                                    <li>
                                        <a class="media" href="{{ route('admin.message.index') }}" style="position:relative">
                                            <span class="badge badge-header badge-info" style="right:auto;left:3px;"></span>
                                            <div class="media-body">
                                                <p class="mar-no text-nowrap text-main text-semibold">{{ $unread }} new Message(s)</p>
                                            </div>
                                        </a>
                                    </li>
                                @endif
