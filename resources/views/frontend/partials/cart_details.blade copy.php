            ...
            <div class="form-default bg-white p-4">
                ...
                <div class="row align-items-center pt-4">
                    ...
                    <div class="col-6 text-right">
                        @if(Auth::check())
                            <a href="{{ route('checkout.shipping_info') }}" class="btn btn-styled btn-base-1"><i class="la la-mail-forward"></i> {{__('Continue to Shipping')}}</a>
                        @else
                        <a href="{{ route('cart.login') }}" class="btn btn-styled btn-base-1"><i class="la la-mail-forward"></i> {{__('Continue to Shipping')}}</a>
                        @endif
