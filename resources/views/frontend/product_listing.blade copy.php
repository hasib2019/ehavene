            ...
            <div class="row">
                <div class="col">
                    <ul class="breadcrumb">
                        ...
                        @if(isset($category_id))
                            <li class="active"><a href="{{ route('products.category', $category_id) }}">{{ \App\Models\Category::find($category_id)->name }}</a></li>
                        @endif
                        @if(isset($subcategory_id))
                            <li ><a href="{{ route('products.category', \App\Models\SubCategory::find($subcategory_id)->category->id) }}">{{ \App\Models\SubCategory::find($subcategory_id)->category->name }}</a></li>
                            <li class="active"><a href="{{ route('products.subcategory', $subcategory_id) }}">{{ \App\Models\SubCategory::find($subcategory_id)->name }}</a></li>
                        @endif
                        @if(isset($subsubcategory_id))
                            <li ><a href="{{ route('products.category', \App\Models\SubSubCategory::find($subsubcategory_id)->subcategory->category->id) }}">{{ \App\Models\SubSubCategory::find($subsubcategory_id)->subcategory->category->name }}</a></li>
                            <li ><a href="{{ route('products.subcategory', \App\Models\SubsubCategory::find($subsubcategory_id)->subcategory->id) }}">{{ \App\Models\SubsubCategory::find($subsubcategory_id)->subcategory->name }}</a></li>
                            <li class="active"><a href="{{ route('products.subsubcategory', $subsubcategory_id) }}">{{ \App\Models\SubSubCategory::find($subsubcategory_id)->name }}</a></li>
                        @endif
                    </ul>
                </div>
            </div>
                                ...
                                @foreach (\App\Models\Category::all() as $key => $category)
                                    <div class="single-category">
                                        <button class="btn w-100 category-name collapsed" type="button" data-toggle="collapse" data-target="#category-{{ $key }}" aria-expanded="true">
                                           <a href="{{ route('products.category', $category->id) }}"> {{ __($category->name) }}</a>
                                        </button>
                    ...
                    <div class="bg-white sidebar-box mb-3">
                        ...
                        <div class="box-content">
                            <div class="range-slider-wrapper mt-3">
                                ...
                                <div id="input-slider-range" data-range-value-min="{{ filter_products(\App\Models\Product::all())->min('unit_price') }}" data-range-value-max="{{ filter_products(\App\Models\Product::all())->max('unit_price') }}"></div>
                                    ...
                                    <ul class="inline-links">
                                        ...
                                        @foreach ($brands as $key => $id)
                                            @if (\App\Models\Brand::find($id) != null)
                                                <li><a href="{{ route('products.brand', $id) }}"><img src="{{ asset(\App\Models\Brand::find($id)->logo) }}" alt="" class="img-fluid"></a></li>
                                            @endif
                                        @endforeach
                                    </ul>
                                </div>
