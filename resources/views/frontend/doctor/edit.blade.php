                        ...
                        <div class="row">
                            <div class="order-xl-2 order-lg-2 col-xl-12 col-lg-8 col-md-12 col-12">
                                <div class="team-detail-box-layout1">
                                    ...
                                    <div class="single-item">
                                        <form action="{{ route('doctor.education.update', encrypt($education->id)) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-box bg-white mt-4">
                                                <div class="form-box-content p-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control mb-3" placeholder="{{__('Degree')}}" name="degree" value="{{ $education->degree }}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control mb-3" placeholder="{{__('Institute')}}" name="institute" value="{{ $education->institute }}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="number" class="form-control mb-3" placeholder="{{__('Year')}}" name="year" value="{{ $education->year }}">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="text-right mt-4">
                                                <button type="submit" class="btn btn-styled btn-base-1">{{__('Update')}}</button>
                                            </div>
                                    ...
                                    <div class="single-item">
                                        <form action="{{ route('doctor.experience.update', encrypt($experience->id)) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-box bg-white mt-4">
                                                <div class="form-box-content p-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="number" class="form-control mb-3" placeholder="{{__('Year')}}" name="year" value="{{ $experience->year }}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control mb-3" placeholder="{{__('Department')}}" name="department" value="{{ $experience->department }}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control mb-3" placeholder="{{__('Position')}}" name="position" value="{{ $experience->position }}">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control mb-3" placeholder="{{__('Hospital')}}" name="hospital" value="{{ $experience->hospital }}">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="single-item">
                                        <form action="{{ route('doctor.appointment.update', encrypt($appointment->id)) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-box bg-white mt-4">
                                                <div class="form-box-content p-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select name="day" id="day" class="form-control mb-3" >
                                                                <option value="{{ $appointment->day }}">{{ $appointment->day }}</option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select name="time_start" id="time_start" class="form-control mb-3" required>
                                                                <option value="{{ $appointment->time_start }}">{{ $appointment->time_start }}</option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="number" class="form-control mb-3" placeholder="{{__('Number of patient')}}" name="patient_count" value="{{ $appointment->patient_count }}">
                                                        </div>
                                                    </div>
