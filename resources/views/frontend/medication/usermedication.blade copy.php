                        ...
                        <div id="" style="margin-bottom: 20px;">
                            <div style="width:50%; float:left;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea class="form-control" cols="35" rows="2"> {{$users->address}}, {{$area}}, {{$city}}, {{$region}}. </textarea>
                                ...
                                <div class="row">
                                    <label class="col-lg-4 control-label">{{__('Postal Code')}}</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="post_code" value="{{$users->post_code}}">
