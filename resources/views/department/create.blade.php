        ...
        <form class="form-horizontal" action="{{ route('department.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{__('Name')}}" id="dep_name" name="dep_name" class="form-control" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="dep_code">{{__('Code')}}</label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{__('Code')}}" id="dep_code" name="dep_code" class="form-control" required>
                    </div>
                </div>
                <div class="form-group">
