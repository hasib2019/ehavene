...
@section('content')
    <div class="col-lg-6 col-lg-offset-3">
        <div class="panel">
            ...
            <!--Horizontal Form-->
            <!--===================================================-->
            <form class="form-horizontal" action="{{ route('shippingmethod.store') }}" method="POST" enctype="multipart/form-data">
            	@csrf
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="number" placeholder="{{__('Price')}}" id="price" name="price" class="form-control" required>
                        </div>
                    </div>
                </div>
