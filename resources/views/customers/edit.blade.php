...
<div class="col-lg-6 col-lg-offset-3">
    <div class="panel">
        ...
        <!--Horizontal Form-->
        <!--===================================================-->
        <form class="form-horizontal" action="{{ route('patient.update', $customers->id) }}" method="POST" enctype="multipart/form-data">
        	@csrf
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="name">{{__('Name')}}</label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{__('Name')}}" id="name" name="name" class="form-control" value="{{ $customers->name}}" required>
                        <input type="hidden" id="userid" name="userid" class="form-control" value="{{ $customers->id}}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" name="email" id="email" class="form-control"  value="{{ $customers->email}}"  placeholder="Email">
                        <input type="hidden" name="exemail" id="exemail" class="form-control"  value="{{ $customers->email}}"  placeholder="Email">
                        <span id="error_email"></span>
                    </div>
                    @error('email')
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{__('Phone No')}}" id="phone" name="phone"  value="{{ $customers->phone}}"  class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea name="address" id="address" cols="20" rows="20" placeholder="type full address"> {{ $customers->address}} </textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control mb-3" data-placeholder="Select your region" id="division" name="region" required>
                            <option value=" 
                            @if ($customers->region)
                                {{ \App\Models\Division::where('id', $customers->region)->first()->id}}
                            @else @endif "> 
                            @if ($customers->region)
                                {{ \App\Models\Division::where('id', $customers->region)->first()->name}}
                            @else
                            ---Select Region---
                            @endif  </option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control mb-3" data-placeholder="Select your City" id="district" name="city" required>
                            <option value=" @if ($customers->city)
                                {{ \App\Models\District::where('id', $customers->city)->first()->id}}
                            @else 
                            @endif "> @if ($customers->city)
                                {{ \App\Models\District::where('id', $customers->city)->first()->name}}
                            @else
                            ---Select City---
                            @endif  </option>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control mb-3" data-placeholder="Select your Area" id="upazila" name="area" required>
                            <option value=" @if ($customers->area)
                                {{ \App\Models\Upazila::where('id', $customers->area)->first()->id}}
                            @else 
                            @endif "> @if ($customers->city)
                                {{ \App\Models\Upazila::where('id', $customers->area)->first()->name}}
                            @else
                            ---Select Area---
                            @endif  </option>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control mb-3" data-placeholder="Select shipping Cost " id="shipping" name="shipping_cost" required>
                            <option value="{{ $customers->shipping_cost}}">{{ $customers->shipping_cost}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="postal_code" id="postal_code" class="form-control" placeholder="postal code" maxlength="4" value="{{ $customers->postal_code}}" required>
                    </div>
                </div>
