      ...
      <div class="col-md-3">
        <div class="tile p-0">
          <ul class="nav flex-column nav-tabs user-tabs">
            <li class="nav-item"><a class="nav-link active" href="#user-image" style="color: Black !important;" data-toggle="tab">Image</a></li>
            <li class="nav-item"><a class="nav-link" href="#user-details" style="color: Black !important;" data-toggle="tab">User Details</a></li>
            <li class="nav-item"><a class="nav-link" href="#user-password" style="color: Black !important;" data-toggle="tab">Change Password</a></li>
                        ...
                        <div style="display: flex;">
                            <div>
                                <img class="imgPreview img img-circle"
                                 width="80" src="{{asset('images/'.$profile_data->avatar_original)}}">
                            </div>
